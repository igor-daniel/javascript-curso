...
const newCarros2 = carros3.map((item) => {
...
const numeros4 = [2, 4, 6, 8, 10, 12, 14];
const numerosX3 = numeros4.map(n => n * 3);
...
const numeros5 = [2, 4, 6, 8, 10, 12, 14];
const numerosX32 = numeros5.map(n => n * 3);
...
const buscaMaior453 = numeross.filter(x => x > 45); // [88, 101]
